...
const { activeWorkspaceId, isWorkspaceSettingsPageOpened, isIntegrationsPageOpened, isChatPageOpened, isProductPageOpened, isProductMatcherPageOpened, isWorkspacesLoading } =
  storeToRefs(workspaceStore)

const { navigateToWorkspaceSettings, navigateToIntegrations: _navigateToIntegrations, navigateToChat: _navigateToChat, navigateToProduct, navigateToProductMatcher } = workspaceStore

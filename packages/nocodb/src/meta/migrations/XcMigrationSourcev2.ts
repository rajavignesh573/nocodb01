...
import * as nc_091_ai_conversations from '~/meta/migrations/v2/nc_091_ai_conversations';
import * as nc_092_ai_messages from '~/meta/migrations/v2/nc_092_ai_messages';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_091_ai_conversations':
        return nc_091_ai_conversations;
      case 'nc_092_ai_messages':
        return nc_092_ai_messages;
    }
  }
}

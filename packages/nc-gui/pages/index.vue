...
const isSharedView = computed(() => {
  ...
  return (
    ...
    !['index', 'index-typeOrId', 'index-typeOrId-feed', 'index-typeOrId-integrations', 'index-typeOrId-chat', 'index-typeOrId-product', 'index-typeOrId-product-matcher'].includes(routeName)
  )
})

...
const { isWorkspaceLoading, isWorkspaceSettingsPageOpened, isIntegrationsPageOpened, isChatPageOpened, isProductPageOpened } = storeToRefs(workspaceStore)

const { navigateToWorkspaceSettings, navigateToIntegrations: _navigateToIntegrations, navigateToChat, navigateToProduct } = workspaceStore

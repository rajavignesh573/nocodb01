...
const [useProvideMapViewStore, useMapViewStore] = useInjectionState(
  (
    ...
    async function loadMapMeta() {
      ...
      mapMetaData.value = isPublic.value ? (sharedView.value?.view as MapType) : await $api.dbView.dbViewMapRead(viewMeta.value.id)
    ...
    async function updateMapMeta(updateObj: Partial<MapType>) {
      ...
      await $api.dbView.dbViewMapUpdate(viewMeta.value.id, updateObj)
    }

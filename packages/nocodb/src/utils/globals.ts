export enum MetaTable {
  ...
  AI_CONVERSATIONS = 'nc_ai_conversations',
  AI_MESSAGES = 'nc_ai_messages',
  PRODUCT_MATCH_SOURCES = 'nc_product_match_sources',
  PRODUCT_MATCH_BRAND_SYNONYMS = 'nc_product_match_brand_synonyms',
  PRODUCT_MATCH_CATEGORY_MAP = 'nc_product_match_category_map',
  PRODUCT_MATCH_RULES = 'nc_product_match_rules',
  PRODUCT_MATCH_SESSIONS = 'nc_product_match_sessions',
  PRODUCT_MATCHES = 'nc_product_matches',
  PRODUCT_MATCH_CANDIDATES = 'nc_product_match_candidates',
  PRODUCT_SEARCH_LOG = 'nc_product_search_log',
}
